export const FeederPoolVaultABI = [
  {
    inputs: [
      { internalType: 'address', name: '_nexus', type: 'address' },
      { internalType: 'address', name: '_stakingToken', type: 'address' },
      { internalType: 'address', name: '_boostDirector', type: 'address' },
      { internalType: 'uint256', name: '_priceCoeff', type: 'uint256' },
      { internalType: 'uint256', name: '_coeff', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'boostDirector',
    outputs: [
      { internalType: 'contract IBoostDirector', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_last', type: 'uint256' },
    ],
    name: 'claimRewards',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint64', name: 'lastAction', type: 'uint64' },
      { internalType: 'uint64', name: 'rewardCount', type: 'uint64' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint64', name: 'finish', type: 'uint64' },
